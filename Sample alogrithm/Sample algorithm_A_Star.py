# -*- coding: utf-8 -*-
"""
Created on Thu Oct  7 19:01:31 2021
...
class AStar:
    ...
    def BaseCost(self, p, father):
        ...
        if (abs(p.x - father.x) == 1 and abs(p.y - father.y) == 1):
            G = father.cost - self.HeuristicCost(father) + 14 
        else:
            G = father.cost - self.HeuristicCost(father) + 10
        return G
    ...
    def TotalCost(self, p, father):
        ...
        return self.BaseCost(p, father) + self.HeuristicCost(p)
    ...
    def run(self, ax, plt, startPoint, endPoint):
        ...
        self.startPoint.cost = self.HeuristicCost(self.startPoint)
